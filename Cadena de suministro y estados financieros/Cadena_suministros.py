...
def printing(texto,xt,yt):
    ...
    if texto == "Materias Primas":
        tk.Label(wn, text = "Tiempo Materias Primas es {0} meses".format(materias_primas_tiempo)).place(x = xt, y = yt)
        tk.Label(wn, text = "Costo Total Materias Primas es {0}".format(materias_primas_CT)).place(x = xt, y = yt + 30)
    elif texto == "Produccion":
        tk.Label(wn, text = "Tiempo Produccion es {0} meses".format(produccion_tiempo)).place(x = xt, y = yt)
        tk.Label(wn, text = "Costo Total Produccion es {0}".format(produccion_CT)).place(x = xt, y = yt + 30)
    elif texto == "Transporte":
        tk.Label(wn, text = "Tiempo Transporte es {0} meses".format(transporte_tiempo)).place(x = xt, y = yt)
        tk.Label(wn, text = "Costo Total Transporte es {0}".format(transporte_CT)).place(x = xt, y = yt + 30)
    elif texto == "Almacenamiento":
        tk.Label(wn, text = "Tiempo Almacenamiento es {0} meses".format(almacenamiento_tiempo)).place(x = xt, y = yt)
        tk.Label(wn, text = "Costo Total Almacenamiento es {0}".format(almacenamiento_CT)).place(x = xt, y = yt + 30)
    elif texto == "Ventas":
        tk.Label(wn, text = "Tiempo Ventas es {0} meses".format(ventas_tiempo)).place(x = xt, y = yt)
        tk.Label(wn, text = "Costo Total Ventas es {0}".format(ventas_CT)).place(x = xt, y = yt + 30)
